...
namespace Selenium.Pages.Outcome
{
    public class OutcomeSearchPage : BasePage
    {
        ...
        [FindsBy(How = How.XPath, Using = "(//div[@class='row'])[5]/div[1]/div/div[1]")]
        ...
        public void SearchOutcome()
        {
            ...
            var searchTypeInput = FindBy(By.XPath("(//div[@class='row'])[5]/div[1]/div/div[1]/following-sibling::input[1]"), 1, true);
