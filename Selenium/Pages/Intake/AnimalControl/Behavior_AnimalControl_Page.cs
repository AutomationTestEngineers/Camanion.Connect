...
{
    public class Behavior_AnimalControl_Page : BasePage
    {
        public Behavior_AnimalControl_Page(IWebDriver driver) : base(driver) { }
        ...
        public Medical_AnimalControl_Page EnterBehavior()
        {
            ...
            return new Medical_AnimalControl_Page(driver);
        }
    }
}
